...
function locator(value, fromIndex) {
  ...
  for (
    var _i = 0, _Object$keys = Object.keys(markers);
...
function inlinePlugin() {
  function inlineTokenizer(eat, value, silent) {
    ...
    for (
      var _i2 = 0, _Object$keys2 = Object.keys(markers);
    ...
    if (
      ...
      for (
        ;
        value[endMarkerIndex] !== marker && endMarkerIndex < value.length;
        endMarkerIndex++
